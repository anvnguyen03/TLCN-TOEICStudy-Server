...
//    @Value("${payment.vnPay.tmnCode}")
    private String vnp_TmnCode = "F5D75S00";
    @Getter
//    @Value("${payment.vnPay.secretKey}")
    private String secretKey = "9OKXFAG2AB7VIS08KIK5UHZE75ENFCQJ";
...
//    @Value("${payment.vnPay.orderType}")
    ...
    public Map<String, String> getVNPayConfig(String userId, String courseId) {
        ...
        vnpParamsMap.put("vnp_ReturnUrl", this.vnp_ReturnUrl+"?userId="+userId+"&courseId="+courseId);
